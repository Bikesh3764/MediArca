...
-- Supabase Auth owns credentials; this trigger mirrors non-secret profile data only.
-- It is deliberately non-blocking: a profile mirror failure must never prevent Auth sign-in.
