...
class MediarcaStore {
  ...
  setAuthSession(sessionData) {
    ...
    this.state.currentUser = {
      ...
      age: clinicalProf.age ?? patientProf.age ?? this.state.currentUser?.age ?? null,
      gender: clinicalProf.gender ?? patientProf.gender ?? this.state.currentUser?.gender ?? null,
      bloodGroup: clinicalProf.blood_group ?? patientProf.blood_group ?? this.state.currentUser?.bloodGroup ?? null,
