/**
 * Pizza Ready! 3D Tycoon - Screen-Space HUD & World Decal Projector Engine
 * High-performance 3D-to-2D UI projection, floating emoji particles, and compass navigation.
 * Unity Portability: Maps to WorldSpaceCanvasManager.cs, CompassNavigation.cs, ScreenVFX.cs
 */

class ScreenSpaceHUDEngine {
  constructor(camera, worldUiContainer, floatersContainer) {
    this.camera = camera;
    this.worldUi = worldUiContainer;
    this.floaters = floatersContainer;
    this.flyingCoins = [];
  }
...
window.ScreenSpaceHUDEngine = ScreenSpaceHUDEngine;
