/**
 * Pizza Ready! 3D Tycoon - High-Poly Pizzeria Procedural Asset Library
 * Ultra-detailed commercial 3D models matching top-charting mobile tycoon games.
 * Unity Portability: Maps to PizzeriaAssetLibrary.cs, ProceduralMeshGenerators.cs
 */

class HighPolyPizzeriaModels {
  constructor() {
    this.cache = new Map();
  }
...
window.HighPolyPizzeriaModels = HighPolyPizzeriaModels;
window.pizzeriaModels = new HighPolyPizzeriaModels();
