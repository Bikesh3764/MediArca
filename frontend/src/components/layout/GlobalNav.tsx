...
export const GlobalNav: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#000000] text-white h-11 flex items-center border-b border-white/10 select-none">
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 flex items-center justify-between text-[12px] font-normal tracking-tight">
        {/* Brand */}
          ...
          {user ? (
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline text-xs text-white/90 max-w-[120px] truncate">
                  {user.fullName}
                </span>
